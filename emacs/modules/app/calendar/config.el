...
(use-package! calfw
  ...
  (when (featurep! :editor evil +everywhere)
    ...
    (map! (:map cfw:calendar-mode-map
           ...
           :m "l"   #'cfw:navi-previous-day-command
           :m "L"   #'cfw:navi-goto-first-date-command
           :m "ç"   #'cfw:navi-next-week-command
           :m "j"   #'cfw:navi-previous-week-command
           :m "k"   #'cfw:navi-next-day-command
           :m "K"   #'cfw:navi-goto-last-date-command
          ...
          (:map cfw:details-mode-map
           ...
           :m "C-j" #'cfw:details-navi-prev-command
           :m "C-ç" #'cfw:details-navi-next-command
           :m "C-l" #'cfw:details-navi-prev-item-command
           :m "C-k" #'cfw:details-navi-next-item-command)))
